...
public class VentanaAdminN extends JFrame {
	...
	public VentanaAdminN() {
		...
		pnlIzquierda.setLayout(new MigLayout("", "[][183.00,grow][][grow][189.00][][]", "[36.00][grow][][][][][][][][][][][][][][][]"));
		...
		pnlIzquierda.add(lblTAlmacen, "cell 1 0 4 1,grow");
		tRopa = new JTable(mRopa);
		//sRopa.setViewportView(tRopa);
		pnlIzquierda.add(tRopa, "cell 1 1 4 9,grow");
		...
		pnlIzquierda.add(btnDescatalogar, "cell 3 16 2 1,grow");
