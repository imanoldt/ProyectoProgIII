...
public class VentanaMain extends JFrame {
	...
	public VentanaMain() {
		...
		lblMenu = new JLabel("");
		lblMenu.setIcon(new ImageIcon(VentanaMain.class.getResource("/img/icnMenu.png")));
		...
		sl_pnlSuperior.putConstraint(SpringLayout.EAST, lblMenu, 58, SpringLayout.WEST, pnlSuperior);
